...
import 'package:pos_portal/pages/settings/struk-edit_page.dart';
import 'package:pos_portal/pages/settings/webhook-edit_page.dart';
...
class SettingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: topBar(context: context, title: 'Pengaturan',),
      body: BodyTemplate(
        child: Column(
          children: [
            ListTile(
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => EditWebhook()),
                );
              },
            ),
          ],
